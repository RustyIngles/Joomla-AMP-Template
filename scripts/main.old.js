$('document').ready(function() {
  ...
  var chkWidth = function() {
      ...
      var uaMode = (viewportWidth <= 729) ? $('header nav ul.desktop-nav > li:nth-child(3) a').html('<i class="fa fa-user" aria-hidden="false"></i>') : $('header nav ul.desktop-nav > li:nth-child(3) a').html('Account');
      var rqMode = (viewportWidth <= 729) ? $('header nav ul.desktop-nav > li:nth-child(4) a').html('<i class="fa fa-archive" aria-hidden="true"></i>') : $('header nav ul.desktop-nav > li:nth-child(4) a').html('Retrieve a quote');
  };
